#!/usr/bin/env python3
"""
Interactive Figure 2: axial anisotropy in cubochoric KR grids.

Loads pre-computed data from ``figures/data/figure2_anisotropy.json``.
...
DATA_FILE = str(_HERE / "data" / "figure2_anisotropy.json")
DEFAULT_STEM = "cubochoric_anisotropy"
DEFAULT_SETTINGS_JSON = str(_HERE / "settings" / "cubochoric_anisotropy.json")
DPI = PAPER_DPI
...
@dataclass
class Settings:
    # Typography — paper defaults (legible at single-column width)
    ...
    # Figure size — paper single-column
...
def load_data(path: str) -> dict:
    if not os.path.exists(path):
        print(
            f"Error: data file '{path}' not found. Run "
            "`python -m figures.generate_cubochoric_anisotropy` first."
        )
        sys.exit(1)
    with open(path) as f:
        return json.load(f)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#  Panel drawing (shared by interactive UI and paper export)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
