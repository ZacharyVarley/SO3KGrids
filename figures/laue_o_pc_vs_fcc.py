#!/usr/bin/env python3
"""
Primitive-cubic KR vs FCC-KR for Laue O in 2x3 views.
...
from src.orientation_ops import cu2ho, cu2qu, qu_norm, qu_std, qu2ho, rf2qu

LAUE_O = 11
CARD_O = 24
_HERE = Path(__file__).resolve().parent
SETTINGS_FILE = str(_HERE / "settings" / "laue_o_pc_vs_fcc.json")
DEFAULT_STEM = "laue_o_pc_vs_fcc"
SETTINGS_VERSION = 2
